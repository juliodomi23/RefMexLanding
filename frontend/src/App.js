...
const WHATSAPP_NUMBER = "5219611807499";
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}`;

// Logo URLs
const LOGO_METALLIC = "https://customer-assets.emergentagent.com/job_03260dd2-d13e-48a4-92a5-b5b5239906d3/artifacts/yx37bokz_metal%20Logo%201.png";
...
// Values data
const VALUES = [
  { icon: Shield, title: "Integridad", desc: "Actuamos con honestidad y transparencia en cada decisión" },
  { icon: Eye, title: "Objetividad", desc: "Mantenemos criterio independiente y profesional" },
  { icon: Award, title: "Diligencia y Competencia", desc: "Compromiso con la excelencia y actualización constante" },
  { icon: Lock, title: "Confidencialidad", desc: "Protegemos la información con máxima seguridad" },
  { icon: Briefcase, title: "Comportamiento Profesional", desc: "Cumplimos con los más altos estándares éticos" }
];
...
const Navbar = ({ activeSection }) => {
  ...
  return (
    <>
      <nav className={`navbar-fixed transition-all duration-300 ${scrolled ? 'py-3' : 'py-4'}`} data-testid="navbar">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <a href="#hero" onClick={(e) => scrollToSection(e, '#hero')} data-testid="navbar-logo">
              <img src={LOGO_WHITE} alt="REFMEX" className="h-10 w-auto" />
            </a>
          ...
          >
            ...
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollToSection(e, link.href)}
                className="text-xl uppercase tracking-wider text-white hover:text-[#D4AF37] transition-colors"
              >
                {link.label}
              </a>
            ))}
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-gold text-lg uppercase tracking-wider mt-4"
            >
              Agendar Asesoría
            </a>
          </motion.div>
    ...
    <section id="hero" className="hero-section" data-testid="hero-section">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-medium text-center mb-6 leading-tight" data-testid="hero-title">
            Más que un proveedor de servicios;{" "}
            <span className="text-gold-gradient">tu aliado estratégico para el crecimiento</span>
          </h1>
          
          <p className="text-[#A1A1AA] text-base sm:text-lg lg:text-xl text-center max-w-3xl mb-10" data-testid="hero-subtitle">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-0" data-testid="hero-stats">
            <div className="text-center px-8">
              <div className="text-gold-gradient text-4xl sm:text-5xl font-serif font-medium">30+</div>
              <div className="text-[#A1A1AA] text-sm uppercase tracking-wider mt-1">Años de Experiencia</div>
            </div>
            <div className="stat-divider hidden sm:block" />
            <div className="text-center px-8">
              <div className="text-gold-gradient text-4xl sm:text-5xl font-serif font-medium">3</div>
              <div className="text-[#A1A1AA] text-sm uppercase tracking-wider mt-1">Oficinas en México</div>
            </div>
            <div className="stat-divider hidden sm:block" />
            <div className="text-center px-8">
              <div className="text-gold-gradient text-4xl sm:text-5xl font-serif font-medium">12+</div>
              <div className="text-[#A1A1AA] text-sm uppercase tracking-wider mt-1">Servicios Especializados</div>
            </div>
          </div>
        </motion.div>
      </div>
...
const AboutSection = () => {
  return (
    <section id="nosotros" className="section-surface py-24 md:py-32" data-testid="about-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Conócenos</p>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-white" data-testid="about-title">
              ¿Quiénes Somos?
            </h2>
            <p className="text-[#A1A1AA] text-lg mt-4">Red de Estudios Fiscales de México</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <p className="text-[#A1A1AA] leading-relaxed">
                <span className="text-white font-medium">REFMEX</span> nació de la necesidad de compartir experiencia entre fiscalistas y abogados, socios del Instituto Mexicano de Contadores Públicos con hasta 30 años de experiencia en el mercado.
              </p>
              <p className="text-[#A1A1AA] leading-relaxed">
...
const ValuesSection = () => {
  return (
    <section id="valores" className="section-dark py-24 md:py-32 relative overflow-hidden" data-testid="values-section">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Nuestros Principios</p>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-white" data-testid="values-title">
              Nuestros Valores
            </h2>
            <p className="text-[#A1A1AA] text-lg mt-4 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {VALUES.map((value, idx) => (
              ...
              >
                ...
                <p className="text-[#A1A1AA] text-sm">{value.desc}</p>
              </motion.div>
            ))}
          </div>
...
const ServicesSection = () => {
  return (
    <section id="servicios" className="section-surface py-24 md:py-32 relative" data-testid="services-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Lo que hacemos</p>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-white" data-testid="services-title">
          ...
          <div className="services-grid">
            {SERVICES.map((service, idx) => (
              ...
              >
                <service.icon size={32} className="text-[#D4AF37] mb-4" />
  ...
  return (
    <section id="bolsa-trabajo" className="section-dark py-24 md:py-32" data-testid="job-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Carreras</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            {/* Form */}
            <div className="card-refmex" data-testid="job-form-card">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger className="bg-transparent border-0 border-b border-[#D4AF37]/30 rounded-none text-white focus:ring-0 focus:border-[#D4AF37]" data-testid="job-select-puesto">
                        <SelectValue placeholder="Seleccionar" />
                      </SelectTrigger>
                      <SelectContent className="bg-[#111111] border-[#D4AF37]/30">
                        {JOB_POSITIONS.map((pos, idx) => (
                          <SelectItem key={idx} value={pos} className="text-white hover:bg-[#D4AF37]/10">
                            {pos}
                          </SelectItem>
                        ))}
                      </SelectContent>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-[#A1A1AA] file:mr-4 file:py-2 file:px-4 file:border file:border-[#D4AF37]/30 file:bg-transparent file:text-[#D4AF37] file:cursor-pointer hover:file:bg-[#D4AF37]/10"
...
const BlogSection = () => {
  ...
  return (
    <section id="blog" className="section-surface py-24 md:py-32" data-testid="blog-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Recursos</p>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-white" data-testid="blog-title">
            ...
            <TabsList className="flex justify-center gap-2 mb-12 bg-transparent">
              {categories.map((cat) => (
                <TabsTrigger
                  key={cat.id}
                  value={cat.id}
                  className="blog-tab data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#BF953F] data-[state=active]:via-[#FCF6BA] data-[state=active]:to-[#B38728] data-[state=active]:text-black data-[state=active]:border-transparent"
                  ...
                  {filteredArticles.map((article, idx) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="font-serif text-lg text-white mb-2">{article.title}</h3>
                        <p className="text-[#A1A1AA] text-sm">{article.excerpt}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
...
const ContactSection = () => {
  return (
    <section id="contacto" className="section-dark py-24 md:py-32" data-testid="contact-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4">Contáctanos</p>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-white" data-testid="contact-title">
          ...
          {/* Main CTA Card */}
          <div className="bg-gold-gradient p-8 md:p-12 text-center mb-12" data-testid="contact-cta-card">
            <h3 className="font-serif text-2xl md:text-3xl text-black font-medium mb-4">
              Agenda tu Asesoría
            </h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-black text-white px-8 py-3 font-semibold hover:bg-black/80 transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {OFFICES.map((office, idx) => (
              ...
              >
                <h3 className="font-serif text-xl text-white mb-4">{office.name}</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <MapPin size={18} className="text-[#D4AF37] mt-0.5" />
                    <span className="text-[#A1A1AA] text-sm">{office.address}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Phone size={18} className="text-[#D4AF37]" />
                    <span className="text-[#A1A1AA] text-sm">{office.phone}</span>
                  </div>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-gold-outline w-full mt-6 flex items-center justify-center gap-2 text-sm"
...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#050505] border-t border-[#D4AF37]/20 py-16" data-testid="footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-[#D4AF37] hover:text-[#FCF6BA] transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Nosotros', 'Servicios', 'Bolsa de Trabajo', 'Blog', 'Contacto'].map((link, idx) => (
                <li key={idx}>
                  <a href={`#${link.toLowerCase().replace(/\s/g, '-')}`} className="footer-link text-sm">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {OFFICES.map((office, idx) => (
                <li key={idx} className="flex items-center gap-2 text-[#A1A1AA] text-sm">
                  <Phone size={14} className="text-[#D4AF37]" />
                  {office.phone}
                </li>
              ))}
              <li className="flex items-center gap-2 text-[#A1A1AA] text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-[#D4AF37]/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="#" className="footer-link text-xs">Términos de Uso</a>
              <a href="#" className="footer-link text-xs">Declaración de Privacidad</a>
              <a href="#" className="footer-link text-xs">Descargo de Responsabilidad</a>
            </div>
          </div>
          <p className="text-[#71717a] text-xs mt-4 text-center md:text-left">
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="whatsapp-float bg-[#25D366] animate-pulse-gold"
